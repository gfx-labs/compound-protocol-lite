...
export async function buildCToken(
  ...
  from: string,
  params: Event
): Promise<{ world: World; cToken: ethers.Contract; tokenData: TokenData }> {
  const fetchers = [
    new Fetcher<
      {
        symbol: StringV;
    ...
    `,
      ...
      async (
        ...
        return {
          invokation: await deploy_contract_world<CErc20Delegator>(
            world,
            from,
            "CErc20Delegator",
            [
    ...
    `,
      ...
      async (
        ...
        return {
          invokation: await deploy_contract_world<CErc20DelegatorScenario>(
            world,
            from,
            "CErc20DelegatorScenario",
            [
    ...
    >(
      ...
      async (
        ...
        return {
          invokation: await deploy_contract_world<CErc20Scenario>(
            world,
            from,
            "CToken",
            [
    ...
    >(
      ...
      async (
        ...
        return {
          invokation: await deploy_contract_world<CEtherScenario>(
            world,
            from,
            "CEtherScenarioContract",
            [
              name.val,
              symbol.val,
              decimals.val,
    ...
    >(
      ...
      async (
        ...
        return {
          invokation: await deploy_contract_world<CEther>(
            world,
            from,
            "CToken",
            [
    ...
    >(
      ...
      async (
        ...
        return {
          invokation: await deploy_contract_world<CErc20>(
            world,
            from,
            "CErc20",
            [
    ...
    >(
      ...
      async (
        ...
        return {
          invokation: await deploy_contract_world<CEvil>(world, from, "CEvil", [
            underlying.val,
            comptroller.val,
            interestRateModel.val,
            initialExchangeRate.val,
    ...
    >(
      ...
      async (
        ...
        if (world.isLocalNetwork()) {
          ...
          return {
            invokation: await deploy_contract_world<CErc20Immutable>(
              world,
              from,
              "CErc20Immutable",
              [
  ...
  tokenData.address = cToken.address;
